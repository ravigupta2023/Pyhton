...
outlook = win32.Dispatch('Oulook.Application').GetNamespace('MAPI')
...
data_path = r"C:\Users\et0001301\Documents\ME-MIS_SUMMARY.xlsx"

df = pd.read_excel(data_path,sheet_name = 'out_file')
